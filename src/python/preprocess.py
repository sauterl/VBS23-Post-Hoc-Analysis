...
def main(args):
    ...
    process_team_logs(args.config, comp_data, force=args.force, teams_override=args.teams)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--teams', nargs='+', default=None, help='overrides the list of teams')
